...
nc_med = Dataset(path+'/output/Kenya_ODA_v31_AGBpot_mean_WC2_SOILGRIDS_GridSearch.nc')
...
figmaps.show()
#figmaps.savefig('figures/compare_maps_V2_WC2_SOILGRIDS.png', bbox_inches='tight')
